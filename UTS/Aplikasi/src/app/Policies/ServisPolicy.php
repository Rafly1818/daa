...
class ServisPolicy
{
    ...
    {
        return $user->can('view_any_servis');
    }
    ...
    {
        return $user->can('delete_any_servis');
    }
     ...
     */
    public function replicate(User $user, Servis $servis): bool
    {
